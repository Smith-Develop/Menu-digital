...
export async function POST(request: NextRequest) {
  ...
  async function activate(restaurantId: string, planId: string, subscriptionId: string | null, customerId: string | null) {
    ...
    // sólo admite una suscripción viva por restaurante.
    await supabase
      .from('subscriptions')
