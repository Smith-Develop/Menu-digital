-- =============================================================
--  El local decide si a domicilio se paga antes
--
--  La auditoría dejó esta decisión pendiente antes del bloque 4 porque cambia
--  el flujo del pedido. Se resuelve como interruptor del local y no como regla
--  de la plataforma: en Colombia y en Honduras mucha gente paga en efectivo en
--  la puerta, y obligar a todos dejaría fuera a media clientela de quien no lo
--  necesita.
--
--  La columna la puso la migración 0074. Aquí se le da efecto, que es lo que
--  convierte un interruptor en una regla.
-- =============================================================
