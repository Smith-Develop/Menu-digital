...
export type Database = {
  public: {
    ...
    out.append("      home_banners: { Args: { p_city_slug?: string | null; p_limit?: number }; Returns: { id: string; title: string | null; subtitle: string | null; image_url: string; link_url: string | null; restaurant_id: string; restaurant_name: string; restaurant_slug: string; sponsored: boolean }[] };")
    ...
    out.append("      open_cash_session: { Args: { p_restaurant_id: string; p_float_cents?: number; p_note?: string | null }; Returns: Json };")
    out.append("      close_cash_session: { Args: { p_session_id: string; p_counted_cents: number; p_note?: string | null }; Returns: Json };")
    out.append("      add_cash_movement: { Args: { p_restaurant_id: string; p_kind: Enums<'cash_movement_kind'>; p_amount_cents: number; p_reason: string; p_method?: Enums<'payment_method'> }; Returns: Json };")
    out.append("      cash_session_report: { Args: { p_session_id: string }; Returns: Json };")
    out.append("      current_cash_session: { Args: { p_restaurant_id: string }; Returns: Json };")
    ...
    out.append('      courier_plan: { Args: { p_courier_id?: string | null }; Returns: Json };')
    out.append('      courier_can_use_pool: { Args: { p_courier_id?: string | null }; Returns: boolean };')
    out.append('      commission_rate_for: { Args: { p_subject_type: string; p_subject_id: string }; Returns: number };')
    ...
    out.append("      reserve_sponsorship: { Args: { p_restaurant_id: string; p_kind: Enums<'sponsorship_kind'>; p_starts_on: string; p_ends_on: string }; Returns: Json };")
    out.append('      activate_sponsorship: { Args: { p_id: string }; Returns: Json };')
    out.append('      cancel_sponsorship: { Args: { p_id: string }; Returns: Json };')
    out.append("      sponsorship_availability: { Args: { p_city_slug: string | null; p_kind: Enums<'sponsorship_kind'>; p_from: string; p_to: string }; Returns: Json };")
    out.append('      save_merchant_credentials: { Args: { p_method_id: string; p_credentials: Json }; Returns: Json };')
    out.append('      merchant_credentials: { Args: { p_method_id: string }; Returns: Json };')
    out.append('      merchant_payment_options: { Args: { p_restaurant_id: string }; Returns: Json };')
    out.append('      create_payment_intent: { Args: { p_order_id: string; p_method_id: string }; Returns: Json };')
    out.append('      mark_intent_redirected: { Args: { p_intent_id: string; p_provider_ref: string; p_redirect_url: string; p_raw?: Json | null }; Returns: Json };')
    out.append('      settle_payment_intent: { Args: { p_intent_id: string; p_status: string; p_provider_ref?: string | null; p_raw?: Json | null; p_fee_cents?: number }; Returns: Json };')
